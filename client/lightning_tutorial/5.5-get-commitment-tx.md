...
Click the button below to generate a signed commitment (refund) transaction. If you previously generated a funding transaction, the funding txid will auto-fill. The results are saved to the **Transactions** notebook.
...
Now let's dig into the details! Below is the raw hex of a commitment transaction. Go ahead and copy it, then head over to the **Bitcoin Node** terminal (open it via **TOOLS** in the top-right corner).

```
0200000001bef67e4e2fb9ddeeb3461973cd4c62abb35050b1add772995b820b584a488489000000000038b02b8002c0c62d0000000000160014cc1b07838e387deacd0e5232e1e8b49f4c29e48454a56a00000000002200204adb4e2f00643db396dd120d4e7dc17625f5f2c11a40d857accc862d6b7dd80e3e195220
```

In the Bitcoin Node terminal, run the following command:

```
decoderawtransaction 0200000001bef67e4e2fb9ddeeb3461973cd4c62abb35050b1add772995b820b584a488489000000000038b02b8002c0c62d0000000000160014cc1b07838e387deacd0e5232e1e8b49f4c29e48454a56a00000000002200204adb4e2f00643db396dd120d4e7dc17625f5f2c11a40d857accc862d6b7dd80e3e195220
```
