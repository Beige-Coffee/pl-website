...
<checkpoint id="review-ecdh-bolt8"></checkpoint>
...
Try it yourself! Open the [Bitcoin Node](#open-bitcoin-node) and paste the following command to see the decoded inputs, outputs, and witness data:
