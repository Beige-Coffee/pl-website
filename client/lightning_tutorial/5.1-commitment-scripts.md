...
<checkpoint id="review-funding-pubkey-sort"></checkpoint>
...
> **Tip:** The `hash160` helper function computes RIPEMD160(SHA256(data)) for you. You can view its definition by clicking **browse all files** in the code editor and selecting `ln.py`.
...
<code-intro heading="Coding Exercise: Create to_remote Script" exercises="ln-exercise-to-remote-script"></code-intro>
...
<code-intro heading="Coding Exercise: Create to_local Script" exercises="ln-exercise-to-local-script"></code-intro>
