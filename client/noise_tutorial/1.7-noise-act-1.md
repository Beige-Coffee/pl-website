...
Alice's first step is to create an **Ephemeral Public and Private Key Pair**. If you're wondering why Alice needs an ephemeral key pair, then you may have not been playing close attention earlier in the course! Don't worry, we'll review it in more detail in Step 3!
