...
const SIGNATURES: Record<string, SignatureInfo> = {
  ...
  decompress_pubkey: {
    name: "decompress_pubkey",
    params: "(compressed_pubkey)",
    description: "Decompress a 33-byte public key to an ecdsa point",
    paramDetails: [
  ...
  compress_point: {
    name: "compress_point",
    params: "(point)",
    description: "Compress an ecdsa point to 33-byte SEC1 format",
    paramDetails: [
  ...
  CommitmentKeys: {
    name: "CommitmentKeys",
    params: "(local_payment_key, remote_payment_key, local_delayed_key, revocation_key, local_htlc_key, remote_htlc_key)",
    description: "Data container for all keys in a commitment transaction",
    paramDetails: [
      { name: "local_payment_key", description: "Local node's payment public key" },
      { name: "remote_payment_key", description: "Remote node's payment public key" },
      { name: "local_delayed_key", description: "Local delayed public key (for to_local)" },
      { name: "revocation_key", description: "Revocation public key" },
      { name: "local_htlc_key", description: "Local HTLC public key" },
      { name: "remote_htlc_key", description: "Remote HTLC public key" },
    ],
  },
