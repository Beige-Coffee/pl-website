...
- `unsigned_tx_hex`: The hex-encoded unsigned HTLC Success Transaction.
...
<code-intro heading="Coding Exercises: Received HTLCs" exercises="ln-exercise-received-htlc-script,ln-exercise-htlc-success-tx,ln-exercise-finalize-htlc-success"></code-intro>
