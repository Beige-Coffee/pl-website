...
First, Bob will generate his own Ephemeral Key Pair. This keypair is unique to this Noise connection instance. If Bob were to disconnect and reconnect to Alice, he would generate an entirely new Ephemeral Key Pair, ensuring that each connection uses distinct and random encryption keys.
