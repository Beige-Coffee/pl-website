...
> **Tip:** This exercise uses helpers like `decompress_pubkey`, `compress_point`, and the EC constants `CURVE`, `G`, and `ORDER`. You can view their definitions by clicking **Files** in the exercise toolbar or **browse all files** in the code editor and selecting `ln.py`.
