...
Remember, the goal of Act 1 is to prove to Bob that she knows his public key without revealing her identity in plain text. To do this, she needs to prove to Bob that she derived the correct shared secret, and she will need to make sure Bob can authenticate the proof, trusting that it was not tampered with during transit. Luckily, we have just the function to do that: ChaCha20-Poly1305!
