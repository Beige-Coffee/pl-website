          ...
          const TUTORIAL_CONFIGS = {
            ...
            lightning: {
              checkpoints: [
                ...
                { id: "ln-exercise-htlc-outputs", label: "HTLC Outputs", chapter: "HTLC Commitment Outputs" },
                { id: "htlc-dust", label: "Dust Quiz", chapter: "HTLC Commitment Outputs" },
                { id: "p2wsh-wrapping", label: "P2WSH Quiz", chapter: "HTLC Commitment Outputs" },
              ],
              pages: [
