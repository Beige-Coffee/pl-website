...
- **Transaction Weight**: A measure of transaction size in **weight units** (WU), which accounts for the SegWit discount on witness data.
...
- `funding_txid`: The Funding Transaction ID as raw bytes (internal byte order).
