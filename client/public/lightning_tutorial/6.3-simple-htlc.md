...
As we discussed earlier, to initiate this contract, imagine Alice and Bob created an HTLC output for 405,000 sats. **NOTE**: To ensure this exercise works for everyone, this transaction is already mined within a block in the regtest environment. Below is the raw transaction hex.
```

```

#### View the details of the transaction hex!

You can see the details of this transaction by decoding it in the **Bitcoin Node** terminal. There is a lot going on here, but the important piece to focus on is the **vout**. This part of the transaction lists all of the outputs, their amounts, their index, and their locking scripts. Look for the HTLC output and verify that it's the same as below. The HTLC output will be index 0 (`"n": 0`) and have a value of `0.00405000`.
```
...
**Try it in the Bitcoin Node terminal:** Open the Bitcoin Node terminal (via **TOOLS** in the top-right) and decode the transaction to see its structure:
```
decoderawtransaction 
```
...
Okay, now that we've seen how to convert our witness script to hex, let's take the SHA256 of it and verify that it's the same as the output script in Alice's transaction. Use the tool below to compute the SHA256 of the witness script hex:

<tx-generator id="gen-sha256"></tx-generator>
...
**Yes!** At this point, we've now validated that there is indeed a transaction that has an HTLC output.
...
**Try entering a random string and see if you can guess the preimage!** Use the HASH160 tool below to test your guess:

<tx-generator id="gen-ripemd-sha"></tx-generator>
...
```

```

#### Verify The Preimage

Go ahead and decode the above transaction in the **Bitcoin Node** terminal. We're looking at the hex representation of Bob's claim transaction (seen below).

<p align="center" style="width: 50%; max-width: 300px;">
  <img src="./tutorial_images/BobClaim.png" alt="BobClaim" width="100%" height="auto">
</p>

**Try it in the Bitcoin Node terminal:** Decode Bob's claim transaction to verify the witness stack:
```
decoderawtransaction 
```

Check out the **txinwitness** field. You should see the following:
```
"txinwitness": [
  "3045022100e2da29a8fd55e47b0daa487eca05fc6575e73144b462e7b9d3279f5b3477ec5b0220431532d493dff0d3b9cd7a92a1c713ccacee424188cb51780661762ced10237d01",
...
- Signature: `3045022100e2da29a8fd55e47b0daa487eca05fc6575e73144b462e7b9d3279f5b3477ec5b0220431532d493dff0d3b9cd7a92a1c713ccacee424188cb51780661762ced10237d01`
- Preimage: `50726f6772616d6d696e674c696768746e696e67`
- OP_IF selector (`01` = preimage path): `01`
- Witness Script: `63a9148e0290d1ea6eca43cbcb422dca5b6e0ce847696d882103cfa114ffa28b97884a028322665093af66bb19b0cf91c81eae46e6bb7fff799aac6702c800b1752102744c609aeee71a07136482b71244a6217b3368431603e1e3994d0c2d226403afac68`

</details>

So, according to the above, `50726f6772616d6d696e674c696768746e696e67` is our preimage? Is that right? Well, since we have to represent all data in hex format, then we shouldn't expect to see "ProgrammingLightning" here. Use the tool below to convert "ProgrammingLightning" to hex. Is it the same as the preimage?

<tx-generator id="gen-to-hex"></tx-generator>

If we convert "ProgrammingLightning" to its hex representation, we get `50726f6772616d6d696e674c696768746e696e67` - confirming that the preimage in the witness is indeed the string "ProgrammingLightning"!
...
**Try it in the Bitcoin Node terminal:** Broadcast Bob's claim transaction and watch him claim the HTLC funds!
```
sendrawtransaction 
```
