...
- `commitment_txid_hex`: The hex-encoded txid of the commitment transaction containing the HTLC output.
...
- `unsigned_tx_hex`: The hex-encoded unsigned HTLC timeout transaction.
...
<code-intro heading="Coding Exercises: Offered HTLCs" exercises="ln-exercise-offered-htlc-script,ln-exercise-htlc-timeout-tx,ln-exercise-finalize-htlc-timeout"></code-intro>
