...
Remember, the goal of Act 1 is to prove to Bob that she knows his public key without revealing her identity in plain text. To do this, she needs to prove to Bob that she derived the correct shared secret, and she will need to make sure Bob can authenticate the proof, trusting that it was not tampered with during transit. Luckily, she has just the function to do that: ChaCha20-Poly1305!
...
## Act 1 Summary
With that, Act 1 is complete! Alice has proved to Bob that she knows his Static Public Key, without publicly revealing any information about herself - both to Bob and the broader network. They have also established an initial **shared secret** (`es`), which will be combined with additional ECDH operations in the following acts to form the basis of their encrypted communication.
