...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    kind: "md",
    file: "/onion_routing_tutorial_draft/5.0-fixed-size-packet.md",
  },
  {
    ...
    section: "Building the Packet",
    kind: "md",
    file: "/onion_routing_tutorial_draft/6.0-filler-construction.md",
  },
  {
    ...
    section: "Building the Packet",
    kind: "md",
    file: "/onion_routing_tutorial_draft/7.0-wrapping.md",
  },
  {
    id: "peeling-a-layer",
    ...
    section: "Forwarding",
    kind: "md",
    file: "/onion_routing_tutorial_draft/8.0-peeling.md",
  },
  {
    ...
    section: "Forwarding",
    kind: "md",
    file: "/onion_routing_tutorial_draft/9.0-forwarding-validation.md",
  },
  {
    id: "error-onion",
    ...
    section: "Failures",
    kind: "md",
    file: "/onion_routing_tutorial_draft/10.0-error-onion.md",
  },
  {
    id: "capstone-success",
    ...
    section: "Capstone",
    kind: "md",
    file: "/onion_routing_tutorial_draft/11.0-capstone-success.md",
  },
  {
    id: "capstone-failure",
    ...
    section: "Capstone",
    kind: "md",
    file: "/onion_routing_tutorial_draft/12.0-capstone-failure.md",
  },
  {
    id: "beyond-sphinx",
    title: "Beyond Sphinx",
    section: "Beyond",
    kind: "md",
    file: "/onion_routing_tutorial_draft/13.0-beyond-sphinx.md",
  },
  {
    id: "pay-it-forward",
    ...
    kind: "md",
    file: "/onion_routing_tutorial_draft/14.0-pay-it-forward.md",
  },
];
...
function ChapterContent({
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (!cancelled) {
          setErr(
            "Couldn't load this chapter. If you're on a deployed URL, make sure the markdown files are included under client/public/onion_routing_tutorial_draft/."
          );
          setMd("");
        }
      }
  ...
  const rewriteTutorialImagePaths = (raw: string) => {
    return raw
      .replaceAll('src="./tutorial_images/', 'src="/onion_routing_tutorial_draft/tutorial_images/')
      .replaceAll("src='./tutorial_images/", "src='/onion_routing_tutorial_draft/tutorial_images/");
  };
...
export default function OnionRoutingTutorialDraftPage() {
  return (
    <Switch>
      <Route path="/onion-routing-tutorial-draft">
        <OnionRoutingDraftTutorialShell activeId="intro" />
      </Route>
      <Route path="/onion-routing-tutorial-draft/:chapterId">
        {(params) => {
